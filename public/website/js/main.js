/** ==========================================================================================
  ...
  Project :   Dr. ITM Private Limited - Responsive Multi-purpose HTML5 Template
  Author :    CymolThemes
    ...
    function aqovo_logMarginPadding_content() {
        jQuery(".cmt-expandcontent-yes").each(function () {
            ...
            if (jQuery(this).hasClass("cmt-right-span")) {
                cmt_column_div =
                    ", .cmt-expandcontent_column > .cmt-expandcontent_wrapper ";
                jQuery(
                    ".cmt-expandcontent_column > div" + cmt_column_div,
                    jQuery(this),
