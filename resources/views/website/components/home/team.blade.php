        ...
        <div class="container">
            ...
            <div class="row slick_slider mt_240 res-991-mt-40"
                ...
                <div class="cmt-box-col-wrapper col-lg-3">
                    ...
                    <div class="featured-imagebox featured-imagebox-team style1">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" width="535" height="500" src="{{ asset('website/images/team-member/team-img01.jpg') }}"
                                alt="image">
                        </div>
                ...
                <div class="cmt-box-col-wrapper col-lg-3">
                    ...
                    <div class="featured-imagebox featured-imagebox-team style1">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" width="535" height="500" src="{{ asset('website/images/team-member/team-img02.jpg') }}"
                                alt="image">
                        </div>
                        <div class="featured-content">
                ...
                <div class="cmt-box-col-wrapper col-lg-3">
                    ...
                    <div class="featured-imagebox featured-imagebox-team style1">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" width="535" height="500" src="{{ asset('website/images/team-member/team-img03.jpg') }}"
                                alt="image">
                        </div>
                        <div class="featured-content">
                ...
                <div class="cmt-box-col-wrapper col-lg-3">
                    ...
                    <div class="featured-imagebox featured-imagebox-team style1">
                        <div class="featured-thumbnail">
                            <img class="img-fluid" width="535" height="500" src="{{ asset('website/images/team-member/team-img04.jpg') }}"
                                alt="image">
                        </div>
                        <div class="featured-content">
