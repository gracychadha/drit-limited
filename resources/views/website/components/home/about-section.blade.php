        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-md-12">
                <div class="cmt_single_image-wrapper d-table border-rad_5 overflow-hidden res-991-mt_15">
                    <img width="1400" height="1200" class="img-fluid" src="{{ asset('website/images/single-img-12.jpg') }}" alt="single-12" />
                </div>
            </div>
            <div class="col-xl-6">
                    ...
                    <div class="section-title">
                        ...
                        <div class="title-desc">
                            <p>
                                ...
                                world’s for web applications reliable & solutions.
                            </p>
                        </div>
                    </div>
                    <!-- section title end -->
                    <div class="d-sm-flex pt-10 res-767-pt-0">
                        <div class="d-flex res-575-mb-30">
                            <div class="pl-2 res-575-pl-0 bg-base-skin"></div>
                            <div class="about-overlay-01">
                                <h3>IT solution</h3>
                            </div>
                            <ul class="cmt-list cmt-list-style-icon pt-15 res-575-pt-0">
                                <li>
                                    <i class="icon-asterisk text-base-skin"></i>
                                    <span class="cmt-list-li-content text-base-dark">An well experienced IT services &
                                        solution provider</span>
                                </li>
                                <li>
                                    <i class="icon-asterisk text-base-skin"></i>
                                    <span class="cmt-list-li-content text-base-dark">Backed up by a highly talented and
                                        knowledgeable team</span>
                                </li>
                                <li>
                                    <i class="icon-asterisk text-base-skin"></i>
                                    <span class="cmt-list-li-content text-base-dark">100% resilient, and stable IT
                                        infrastructure
                                        available</span>
                                </li>
                            </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-9 col-sm-12">
                            <h3 class="pl-5 res-991-pl-0 mb-0 pt-15 res-767-pt-20">
                                The IT Solutions & Services Company <br />Funded in<strong class="text-base-skin">
                                    1987</strong>
                            </h3>
                        </div>
                    </div>
