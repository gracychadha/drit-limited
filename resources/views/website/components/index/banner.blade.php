    ...
    <rs-module id="rev_slider_2_1" data-version="6.5.9">
        <rs-slides>
            <rs-slide data-key="rs-1" data-title="Slide" data-thumb="website/images/upload/banner-01.png"
                ...
                <img src="{{ asset('website/images/upload/banner-01.png') }}" title="slider-img-03.jpg" width="1920"
                ...
                <rs-layer id="slider-1-slide-1-layer-0" data-type="text" data-color="#fff" data-rsp_ch="on"
                    data-xy="x:r,r,c,c;xo:35px,35px,0,0;yo:91px,85px,40px,80px;"
                    data-text="w:normal;s:18,18,18,18;l:28,28,28,28;fw:700;" data-dim="minh:0px,0px,none,none;"
                ...
                <rs-layer id="slider-1-slide-1-layer-1" data-type="text" data-color="#05255f" data-rsp_ch="on"
                    data-xy="x:r,r,c,c;xo:34px,34px,0,0;yo:130px,110px,110px,120px;"
                ...
                <rs-layer id="slider-1-slide-1-layer-2" data-type="text" data-color="#05255f" data-rsp_ch="on"
                    data-xy="x:r,r,c,c;xo:34px,34px,0,0;yo:200px,180px,150px,180px;"
                ...
                <rs-layer id="slider-1-slide-1-layer-3" data-type="text" data-color="#676b72" data-rsp_ch="on"
                    ...
                    data-text="w:normal;s:18,18,18,15;l:26,26,26,25;"  data-frame_0="y:-100%;"
            ...
            <rs-slide data-key="rs-4" data-title="Slide" data-thumb="website/images/upload/banner-02.png"
                ...
                <img src="{{ asset('website/images/upload/banner-02.png') }}" title="slider-img-02.jpg" width="1920"
                    height="693" class="rev-slidebg tp-rs-img" data-no-retina="">


                <rs-layer id="slider-1-slide-4-layer-0" data-type="text" data-color="#b30000" data-rsp_ch="on"
                    data-xy="x:r,r,c,c;xo:35px,35px,0,0;yo:91px,85px,40px,80px;"
                    ...
                    data-frame_999="o:0;st:w;sR:7610;" style="z-index:9;font-family: 'Lato', sans-serif;">Value-Driven
                    Excellence
                </rs-layer>
                ...
                <rs-layer id="slider-1-slide-4-layer-3" data-type="text" data-color="#676b72" data-rsp_ch="on"
                    data-xy="x:l,l,c,c;xo:35px,35px,0,666px;yo:300px, 280px,256px,233px;"
                    data-text="w:normal;s:18,18,18,15;l:26,26,26,25;"  data-frame_0="y:-100%;"
                    data-frame_0_mask="u:t;" data-frame_1="st:680;sp:1200;sR:680;" data-frame_1_mask="u:t;"
                    data-frame_999="o:0;st:w;sR:7120;" style="z-index:12;font-family:'Lato', sans-serif;">We provide
                    value-based, high-quality services
