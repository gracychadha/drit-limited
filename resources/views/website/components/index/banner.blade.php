        ...
        <rs-slides>
            <rs-slide data-key="rs-1" data-title="Slide" data-thumb="website/images/upload/banner-01.png"
                ...
                <rs-layer id="slider-1-slide-1-layer-0" data-type="text" data-color="#fff" data-rsp_ch="on"
                    data-xy="x:r,r,c,c;xo:35px,35px,0,0;yo:91px,85px,-17px,-20px;"
                ...
                <rs-layer id="slider-1-slide-1-layer-1" data-type="text" data-color="#05255f" data-rsp_ch="on"
                    data-xy="x:r,r,c,c;xo:34px,34px,0,0;yo:130px,110px,20px,20px;"
                ...
                <rs-layer id="slider-1-slide-1-layer-2" data-type="text" data-color="#05255f" data-rsp_ch="on"
                    data-xy="x:r,r,c,c;xo:34px,34px,0,1px;yo:200px,180px,40px,40px;"
                ...
                <rs-layer id="slider-1-slide-1-layer-3" data-type="text" data-color="#676b72" data-rsp_ch="on"
                    data-xy="x:r,r,c,c;xo:34px,34px,0,666px;yo:300px, 280px,256px,233px;"
            ...
            <rs-slide data-key="rs-4" data-title="Slide" data-thumb="website/images/upload/banner-02.png"
                ...
                <rs-layer id="slider-1-slide-4-layer-0" data-type="text" data-color="#b30000" data-rsp_ch="on"
                    data-xy="x:l,l,c,c;xo:35px,35px,0,0;yo:91px,85px,-17px,-20px;"
                ...
                <rs-layer id="slider-1-slide-4-layer-1" data-type="text" data-color="#05255f" data-rsp_ch="on"
                    data-xy="x:l,l,c,c;xo:35px,35px,0,0;yo:130px,110px,20px,20px;"
                    data-text="w:normal;s:72,72,60,50;l:92,92,80,70;fw:400;" data-frame_0="y:-100%;"
                    data-frame_0_mask="u:t;" data-frame_1="st:310;sp:1200;sR:310;" data-frame_1_mask="u:t;"
                ...
                <rs-layer id="slider-1-slide-4-layer-2" data-type="text" data-color="#05255f" data-rsp_ch="on"
                    data-xy="x:l,l,c,c;xo:35px,35px,0,1px;yo:200px,180px,40px,40px;"
                    data-text="w:normal;s:72,72,60,50;l:92,92,80,70;fw:700;" data-frame_0="y:-100%;"
                    data-frame_0_mask="u:t;" data-frame_1="st:440;sp:1200;sR:440;" data-frame_1_mask="u:t;"
