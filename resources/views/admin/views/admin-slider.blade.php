                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tbody>
                                        @forelse ($SliderImage as $item)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td><img src="{{ asset('storage/' . $item->image) }}" width="120">
                                                </td>
                                                <td> <span
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <span class="form-text text-muted">Allowed JPG, GIF or PNG. Max size of 2MB (1600x450)</span>
                            </div>
                            <div class="col-lg-6 mb-3">
